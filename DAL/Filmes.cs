...
//        public void InserirFilme(Filmes objFilmes)
//        {
//            SqlConnection conn = new SqlConnection(connectionString);

//            conn.Open();

//            string sql = "INSERT INTO Itens VALUES (@codigo, @codigobarras, @titulo, @genero, @ano, @tipo, @preco, @dataadquirida, @valorcusto, @situacao, @atores, @diretor, @fotofilme)";
//            SqlCommand cmd = new SqlCommand(sql, conn);
//            cmd.Parameters.AddWithValue("@codigo", objFilmes.Co);
